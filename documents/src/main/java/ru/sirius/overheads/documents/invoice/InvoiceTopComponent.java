 ...
 */
@ConvertAsProperties(
        dtd = "-//ru.sirius.overheads.documents.invoice//Invoice//EN",
        autostore = false)
@TopComponent.Description(
        preferredID = "InvoiceTopComponent",
        iconBase = "ru/sirius/overheads/documents/invoice/document.png",
        persistenceType = TopComponent.PERSISTENCE_ALWAYS)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "ru.sirius.overheads.documents.invoice.InvoiceTopComponent")
